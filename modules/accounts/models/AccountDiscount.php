 ...
 */
class AccountDiscount extends ActiveRecord
{
    /**
     * @var array
     */
    ...
    {
        return \Yii::t('accounts/discounts', $message, $params);
    }
    ...
    public function rules()
    {
        return [
            ...
            [
                ...
                'message' => self::t('This discount already assigned for current status.')
            ],
            [
                'dates',
                'each',
    ...
    {
        return $this->hasOne(AccountStatus::class, ['uuid' => 'status_uuid']);
    }
