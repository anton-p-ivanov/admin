...
namespace accounts\modules\fields\controllers;
 ...
 * @package accounts\modules\fields\controllers
 */
class FieldsController extends \fields\controllers\FieldsController
{
    ...
    public function actions(): array
    {
        return [
            'filter' => [
                ...
                'viewFile' => '@accounts/modules/fields/views/fields/filter'
            ],
            'settings' => [
                'class' => '\app\components\actions\SettingsAction',
                'modelClass' => FieldSettings::className(),
                'viewFile' => '@accounts/modules/fields/views/fields/settings'
            ],
        ];
    }
    ...
    public function actionIndex()
    {
        ...
        $viewFile = '@accounts/modules/fields/views/fields/index';
    ...
    public function actionCreate()
    {
        $model = new Field([
            ...
            'code' => 'ACCOUNT_FIELD_' . \Yii::$app->security->generateRandomString(6)
        ]);
    ...
    /**
     * We need to override this method to trigger \accounts\modules\fields\models\Field::afterDelete() method.
     * @return boolean
     */
