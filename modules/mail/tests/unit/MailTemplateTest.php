...
class MailTemplateTest extends Unit
{
    ...
    {
        return [
            'templates' => 'mail\tests\fixtures\MailTemplateFixture',
            'templates_types' => 'mail\tests\fixtures\MailTemplateTypeFixture',
            'templates_sites' => 'mail\tests\fixtures\MailTemplateSiteFixture',
        ];
    }
