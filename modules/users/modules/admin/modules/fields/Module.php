...
namespace users\modules\admin\modules\fields;
 ...
 * Class Module
 *
 * @package users\modules\admin\modules\fields
 */
class Module extends \yii\base\Module
{
    ...
    public $controllerMap = [
        'fields' => [
            ...
            'viewPath' => '@users/modules/admin/modules/fields/views/fields'
        ],
        'values' => [
            'class' => 'fields\controllers\ValuesController',
            'modelClass' => FieldValue::class,
            'fieldClass' => Field::class,
            'viewPath' => '@users/modules/admin/modules/fields/views/values'
        ],
        'validators' => [
            'class' => 'fields\controllers\ValidatorsController',
            'modelClass' => FieldValidator::class,
            'fieldClass' => Field::class,
            'viewPath' => '@users/modules/admin/modules/fields/views/validators'
        ],
    ];
    /**
     * @var string
