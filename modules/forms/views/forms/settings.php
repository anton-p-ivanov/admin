...
<div class="modal__container">
    ...
    <div class="modal__body">
        <div class="modal__heading"><?= Yii::t('forms', 'Settings'); ?></div>
        <div class="grid">
            <div class="grid__item">
                <?= $form->field($model, 'sortBy')->dropDownList(FormSettings::getSortFields()); ?>
            </div>
            <div class="grid__item">
                <?= $form->field($model, 'sortOrder')->dropDownList(FormSettings::getSortOrder()); ?>
            </div>
        </div>
