...
return [
    [
        'label' => Yii::t('catalogs/fields', 'Edit'),
    ...
    [
        'label' => Yii::t('catalogs/fields', 'Copy'),
    ...
    [
        'label' => Yii::t('catalogs/fields', 'Copy (with relatives)'),
    ...
    [
        'label' => Yii::t('catalogs/fields', 'Validators'),
    ...
    [
        'label' => Yii::t('catalogs/fields', 'Values'),
    ...
    ['options' => ['class' => 'dropdown__divider']],
    [
        'label' => Yii::t('catalogs/fields', 'Delete'),
