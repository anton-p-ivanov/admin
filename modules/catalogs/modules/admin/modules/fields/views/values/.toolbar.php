...
return [
    'group-1' => [
        [
            ...
            'encode' => false,
            'options' => [
                'title' => Yii::t('catalogs/fields/values', 'Back to fields` list'),
                'data-pjax' => 'false'
            ],
            'url' => [
        ...
        [
            'label' => Yii::t('catalogs/fields/values', 'Create'),
            'options' => [
                'data-toggle' => 'modal',
    ...
    'group-2' => [
        [
            ...
            'items' => [
                [
                    'label' => Yii::t('catalogs/fields/values', 'Refresh'),
    ...
    'selected' => [
         [
            ...
            'options' => [
                ...
                'data-toggle' => 'action',
                'data-pjax' => 'false',
                'title' => Yii::t('catalogs/fields/values', 'Delete selected items')
            ],
        ],
    ],
];